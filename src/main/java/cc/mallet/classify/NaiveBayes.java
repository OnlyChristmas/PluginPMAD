 ...
 * <p>
 * Instances are assumed to be {@link FeatureVector}s
 * <p>
...
public class NaiveBayes extends Classifier implements Serializable
{
  ...
  private static Logged[] logMultinomials (Multinomial[] m)
  {
    Logged[] ml = new Logged[m.length];
  ...
  private void readObject(ObjectInputStream in) throws IOException, ClassNotFoundException {
    ...
    prior = (Logged) in.readObject();
    p = (Logged [])  in.readObject();
