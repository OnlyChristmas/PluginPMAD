...
public class PolylingualTopicModelMultiReadouts implements Serializable {

    static CommandOption.SpacedStrings languageInputFiles = new CommandOption.SpacedStrings
            (PolylingualTopicModelMultiReadouts.class, "language-inputs", "FILENAME [FILENAME ...]", true, null,
    ...
    static CommandOption.String outputModelFilename = new CommandOption.String
            (PolylingualTopicModelMultiReadouts.class, "output-model", "FILENAME", true, null,
    ...
    static CommandOption.String inputModelFilename = new CommandOption.String
            (PolylingualTopicModelMultiReadouts.class, "input-model", "FILENAME", true, null,
    ...
    static CommandOption.String inferencerFilename = new CommandOption.String
            (PolylingualTopicModelMultiReadouts.class, "inferencer-filename", "FILENAME", true, null,
    ...
    static CommandOption.String evaluatorFilename = new CommandOption.String
            (PolylingualTopicModelMultiReadouts.class, "evaluator-filename", "FILENAME", true, null,
                    "A held-out likelihood evaluator for new documents.  " +
                            "By default this is null, indicating that no file will be written.", null);

    static CommandOption.String stateFile = new CommandOption.String
            (PolylingualTopicModelMultiReadouts.class, "output-state", "FILENAME", true, null,
    ...
    static CommandOption.String topicKeysFile = new CommandOption.String
            (PolylingualTopicModelMultiReadouts.class, "output-topic-keys", "FILENAME", true, null,
    ...
    static CommandOption.String docTopicsFile = new CommandOption.String
            (PolylingualTopicModelMultiReadouts.class, "output-doc-topics", "FILENAME", true, null,
    ...
    static CommandOption.Double docTopicsThreshold = new CommandOption.Double
            (PolylingualTopicModelMultiReadouts.class, "doc-topics-threshold", "DECIMAL", true, 0.0,
    ...
    static CommandOption.Integer docTopicsMax = new CommandOption.Integer
            (PolylingualTopicModelMultiReadouts.class, "doc-topics-max", "INTEGER", true, -1,
                    "When writing topic proportions per document with --output-doc-topics, " +
    ...
    static CommandOption.Integer outputModelIntervalOption = new CommandOption.Integer
            (PolylingualTopicModelMultiReadouts.class, "output-model-interval", "INTEGER", true, 0,
    ...
    static CommandOption.Integer outputStateIntervalOption = new CommandOption.Integer
            (PolylingualTopicModelMultiReadouts.class, "output-state-interval", "INTEGER", true, 0,
    ...
    static CommandOption.Integer showTopicsIntervalOption = new CommandOption.Integer
            (PolylingualTopicModelMultiReadouts.class, "show-topics-interval", "INTEGER", true, 50,
    ...
    static CommandOption.Integer optimizeIntervalOption = new CommandOption.Integer
            (PolylingualTopicModelMultiReadouts.class, "optimize-interval", "INTEGER", true, 0,
    ...
    static CommandOption.Integer optimizeBurnInOption = new CommandOption.Integer
            (PolylingualTopicModelMultiReadouts.class, "optimize-burn-in", "INTEGER", true, 200,
    ...
    static CommandOption.Double alphaOption = new CommandOption.Double
            (PolylingualTopicModelMultiReadouts.class, "alpha", "DECIMAL", true, 50.0,
                    "Alpha parameter: smoothing over topic distribution.", null);

    static CommandOption.Double betaOption = new CommandOption.Double
            (PolylingualTopicModelMultiReadouts.class, "beta", "DECIMAL", true, 0.01,
    ...
    public PolylingualTopicModelMultiReadouts(int numberOfTopics) {
        this(numberOfTopics, numberOfTopics);
    }

    public PolylingualTopicModelMultiReadouts(int numberOfTopics, double alphaSum) {
    ...
    public PolylingualTopicModelMultiReadouts(int numberOfTopics, double alphaSum, Randoms random) {
        this(newLabelAlphabet(numberOfTopics), alphaSum, random);
    }

    public PolylingualTopicModelMultiReadouts(LabelAlphabet topicAlphabet, double alphaSum, Randoms random) {
    ...
    public void addInstances(InstanceList[] training) {
        ...
        //add by zlx, maxlength to balance data
//		int[] maxLenghts = new int[numInstances];
//		for (int i = 0; i < numInstances; i++) {
//			for (int language = 0; language < numLanguages; language++) {
//				int tmp = ((FeatureSequence)training[language].get(i).getData()).getLength();
//				if (tmp > maxLenghts[i]) {
//					maxLenghts[i] = tmp;
//				}
//			}
...
//				int oril = tokens.getLength();
//				if (oril > 0) {
//					for (int i = 0; i < maxLenghts[insIndex]/oril-1; i++) {
//						for (int j = 0; j < oril; j++) {
//							tokens.add(tokens.getIndexAtPosition(j));
//						}					
//					}
//				}
...
//			}
    ...
    protected void sampleTopicsForOneDoc(TopicAssignment topicAssignment,
        ...
        //add by zlx
        //calculate the length of all docs and normalize by the max length
//		int maxLength = 0;
//		for (int language = 0; language < numLanguages; language++) {
//			int docLength = 
...
//		int norm = 1;
        for (int language = 0; language < numLanguages; language++) {
            ...
            int docLength =
                    topicAssignment.topicSequences[language].getLength();
//			if (docLength > 0) {
//				norm = maxLength / docLength;
//			}

            //		populate topic counts
            for (int position = 0; position < docLength; position++) {
                localTopicCounts[oneDocTopics[position]] += 1;
            }
        }
    ...
    public double[][][] getTopWordsDist() {
        ...
        for (int lan = 0; lan < numLanguages; lan++) {
            for (int w = 0; w < vocabularySizes[lan]; w++) {
                int[] topicCounts = languageTypeTopicCounts[lan][w];
                int index = 0;
                while (index < topicCounts.length &&
                    ...
                    if (result[lan][topic] == null) {
                        result[lan][topic] = new double[vocabularySizes[lan]];
                    }
                    result[lan][topic][w] = count;
                    countTopicTotal[lan][topic] += count;
                    index++;
                }
            }
        }
...
//				System.out.println(topic);
                for (int w = 0; w < vocabularySizes[lan]; w++) {
                    result[lan][topic][w] = (result[lan][topic][w] + betas[lan]) /
                            (countTopicTotal[lan][topic] + betas[lan] * vocabularySizes[lan]);
//					System.out.print(alphabets[lan].lookupObject(w) + ":" + result[lan][topic][w] + " ");
                }
//				System.out.println();
            }
        }
        ...
        for (int di = 0; di < data.size(); di++) {
            ...
            for (int language = 0; language < numLanguages; language++) {
                ...
                for (int token = 0; token < docLength; token++) {
                    result[di][currentDocTopics[token]]++;
                }
            }

            // And normalize
            for (int topic = 0; topic < numTopics; topic++) {
                result[di][topic] = (result[di][topic] + alpha[topic]) /
                        (totalLength + alphaSum);
            }
        }
        return result;
    }
    ...
    public static PolylingualTopicModelMultiReadouts read(File f) throws Exception {

        PolylingualTopicModelMultiReadouts topicModel = null;

        ObjectInputStream ois = new ObjectInputStream(new FileInputStream(f));
        topicModel = (PolylingualTopicModelMultiReadouts) ois.readObject();
        ois.close();
    ...
    public static void main(String[] args) throws IOException {
        ...
        CommandOption.setSummary(PolylingualTopicModelMultiReadouts.class,
                "A tool for estimating, saving and printing diagnostics for topic models over comparable corpora.");
        CommandOption.process(PolylingualTopicModelMultiReadouts.class, args);
        ...
        if (inputModelFilename.value != null) {
            ...
            try {
                topicModel = PolylingualTopicModelMultiReadouts.read(new File(inputModelFilename.value));
            } catch (Exception e) {
            ...
            topicModel = new PolylingualTopicModelMultiReadouts(numTopicsOption.value, alphaOption.value);
