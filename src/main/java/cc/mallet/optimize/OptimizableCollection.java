...
public class OptimizableCollection {
	...
	{
		ArrayList<ByGradientValue> optimizables;
		
		public ByGradientValue (ByGradientValue... ops) {
			optimizables = new ArrayList<ByGradientValue>(ops.length);
			for (ByGradientValue o : ops)
				optimizables.add(o);
		}
