...
/**
    ...
    `by the instance, "target" is often a label associated with the instance,
     ...
     represents a file name and then be processed by a {@link Pipe} into a CharSequence
     representing the contents of the file, and eventually to a feature vector
     holding indices into an {@link Alphabet} holding words found in the file.
	 ...
	 <p> Rather than store an {@link Alphabet} in the Instance,
